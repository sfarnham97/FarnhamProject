/*
  ...
  This program subscribes to the adafruit dashboard to turn an LED attachted to
  the beagle bone black on and off based on a virtual toggle switch on the
  dashboard. The LED could be swaped with any device to control differnt
  loads.
*/
#include <iostream>
#include <fstream>
...
#define TOPIC       "sfarnham/feeds/projectcpe422.ac-load"
