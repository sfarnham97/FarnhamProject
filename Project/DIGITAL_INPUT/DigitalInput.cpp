/*
  ...
  This program, when run publishes the value of a button to the adafruit
  dashboard as an indciator light

  button is negative logic so indicator light takes negative logic to decide if
...
#define TOPIC      "sfarnham/feeds/projectcpe422.digital-input"
...
int main(int argc, char* argv[]) {
   ...
   GPIO goodName(46);
   goodName.setDirection(INPUT);
   sprintf(str_payload, "%i", goodName.getValue());
