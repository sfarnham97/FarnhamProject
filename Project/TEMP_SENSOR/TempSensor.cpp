/*
  Edited by Shawn Farnham on 11-22-2024
   THis code is to get a tempurature from a analog input temp sensor and publish
   the value to the adafruit dashboard.
*/
#include <iostream>
#include <sstream>
#include <fstream>
...
#define TOPIC      "sfarnham/feeds/projectcpe422.temperature"
...
int main(int argc, char* argv[]) {
   ...
   AnalogIn goodName(0);
   float Temp;
   Temp = getTemperature(goodName.readAdcSample());
   sprintf(str_payload, "%f", Temp);
